...
namespace CeBackupLibNet
{
    internal class InternalCAPI
    {
        ...
        internal delegate void CallBackBackupCallback(string SrcPath, string DstPath, int Deleted, HANDLE Pid);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet=CharSet.Unicode)]
        internal delegate void CallBackCleanupEvent(string SrcPath, string DstPath, int Deleted);
        ...
        internal static extern int SubscribeForBackupEvents(CallBackBackupCallback BackupEventFunction);
        ...
        internal static extern int SubscribeForCleanupEvents(CallBackCleanupEvent CleanupEventFunction);
