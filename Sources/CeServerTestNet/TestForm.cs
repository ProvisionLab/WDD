...
namespace CeServerTestNet
{
    public partial class TestForm : Form
    {
        private CeBackupServerManager _BackupManager;
        private CeRestoreServerManager _RestoreManager;
        ...
        private void btnRestoreGetAll_Click( object sender, EventArgs e )
        {
            try
            {
                ...
                _RestoreManager = CeRestoreServerManager.Instance;
                _RestoreManager.Init( "cetest.ini" );
